...
if (isset($_GET['id'])) {
    ...
    foreach ($products as $product) {
        ...
        echo '<td class="action_column"><button class="rfq-button" data-entity-id="' . $product['entity_id'] . '" data-product-name="' . $product['product_name'] . '" data-unit-id="' . $product['unit_id'] . '" data-value="' . $product['value'] . '">RFQ</button></td>';
        echo '</tr>';
    }    
